  ...
  return (
    <>
      {loading ? (
        ...
        <div className="text-[#E8EAED] relative mt-24 z-50">
          ...
          {lens ? (
            ...
            >
              <div
                className={`md:w-[40rem] rounded-3xl bg-[#303134] py-4 px-6`}
              >
            ...
            >
              <div
                className={`md:w-[40rem] flex-col ${
                  isFocused ? "rounded-3xl" : "rounded-full"
                } ${
                  isFocused ? "bg-[#303134]" : "bg-[#4D5156] hover:bg-[#626467]"
                } `}
              >
                <div title="Search" className="flex h-[3rem] ">
                  ...
                  {search.length > 0 ? (
                    <div className="flex gap-3">
                      <button
                        className="text-[#d2d4d6] font-medium text-xl"
                        onClick={() => setSearch("")}
                      >
                        <X />
                      </button>
                  ...
                  <img
                    ...
                    src="google-lens-removebg-preview.png"
                    className="scale-75 cursor-pointer"
                    alt="Google Lens"
                    ...
                    <div className="">
                      {data.length > 0 ? (
                        data?.map((item, index) => {
                          return (
                            <div
                              className="flex roboto pl-4 pt-1 gap-2 mt-1 text-[17px] font-semibold cursor-pointer  hover:bg-[#3C4043]"
                              key={index}
                            >
                              <Search className="text-[#9E9E9E] scale-75 font-thin mt-1 " />{" "}
                              {item.show.name}
                            </div>
                          );
                        })
                        ...
                        <>
                          <p className="text-[#9E9E9E] pt-4 pl-4">
                            Trending Searches
                          </p>
                          {trendingSearches?.map((item, index) => {
                            return (
                              <div
                                className="flex roboto pl-4 pt-1 gap-2 mt-1 text-[19px] cursor-pointer hover:bg-[#444746]"
                                key={index}
                              >
                                <TrendingUp className="text-[#9E9E9E] mt-1 font-thin " />
                                {item}
                              </div>
                            );
                          })}
                      ...
                      <div className="relative">
                        <div className="p-4 flex justify-center ">
                          <button className="bg-[#3C4043] text-[#E8EAED] rounded-md p-2 ml-2 border border-transparent hover:border-[#5f5c5c]">
                            Google Search
                          </button>
                          <button className="bg-[#3C4043] text-[#E8EAED] rounded-md p-2 ml-2 border border-transparent hover:border-[#5f5c5c]">
                            I'm Feeling Lucky
              ...
              {!isFocused ? (
                <div className="w-full">
                  <div className="p-4 flex justify-center flex-wrap space-x-2">
                    <button className="bg-[#303134] text-[#E8EAED] p-2 rounded-md border border-transparent hover:border-[#5f5c5c]">
                      Google Search
                    </button>
                    <button className="bg-[#303134] text-[#E8EAED] p-2 rounded-md border border-transparent hover:border-[#5f5c5c]">
                      I'm Feeling Lucky
                  ...
                  <div className="flex flex-wrap justify-center mt-4 space-x-2 text-center text-xs">
                    <p className="text-[#BFBFBF]">Google offered in:</p>
                    <p className="pl-2 text-[#99C3FF] cursor-pointer hover:underline">
                      हिन्दी
                    </p>
                    <p className="pl-2 text-[#99C3FF] cursor-pointer hover:underline">
                      বাংলা
